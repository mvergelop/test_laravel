...
CREATE TABLE `config` (
  ...
  `adjunto1_filename` varchar(100) DEFAULT NULL,
  `adjunto2` varchar(100) DEFAULT NULL,
  `adjunto2_filename` varchar(100) DEFAULT NULL,
  `created_at` date DEFAULT NULL,
  `updated_at` date DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `config` VALUES (1,'C:\\wamp64\\www\\condosoft\\public/storage/condosoft.sql',NULL,'C:\\wamp64\\www\\condosoft\\public/storage/respaldobdmysql.bat',NULL,'2017-02-14','2017-02-14');
...
-- Dump completed on 2017-02-13 21:21:03

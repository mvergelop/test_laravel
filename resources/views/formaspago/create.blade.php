        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @include ('alerts.request')
                ...
                {!!Form::open(['route'=>'formaspago.store', 'method'=>'POST','class' => 'form-horizontal form-label-left'])!!}
                    ...
                    <div class="form-group">
                        {!!Form::label('lb_saldo','Saldo Inicial:',['class' =>'control-label col-md-3 col-sm-3 col-xs-12'])!!}
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!!Form::text('saldo_inicial',null,['class'=>'form-control col-md-7 col-xs-12'])!!}
                        </div>
                    </div>

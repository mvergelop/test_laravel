            ...
            @include ('alerts.request')
                ...
                {!!Form::open(['url'=>$action, 'method'=>$method,'class' => 'form-horizontal form-label-left'])!!}
                    ...
                    <div class="form-group">
                        {!!Form::label('lb_tipogasto','Tipo:',['class' =>'control-label col-md-3 col-sm-3 col-xs-12'])!!}
                                        
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control col-md-7 col-xs-12" name="tipo">
                              <option value="0" @if ($tipogasto->tipo == '0') selected @endif )>Gasto Ordinario</option>
                              <option value="1" @if ($tipogasto->tipo == '1') selected @endif>Gasto Extraordinario</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!!Form::text('descripcion',$tipogasto->descripcion,['class'=>'form-control col-md-7 col-xs-12'])!!}
                        </div>
                    </div>

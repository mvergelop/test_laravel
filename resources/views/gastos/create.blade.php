        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @include ('alerts.request')
                ...
                {!!Form::open(['route'=>'gastos.store', 'method'=>'POST','class' => 'form-horizontal form-label-left'])!!}

                    <div class="form-group">
                        {!!Form::label('lb_tipogasto','Tipo Gasto:',['class' =>'control-label col-md-3 col-sm-3 col-xs-12'])!!}
                                        
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control col-md-7 col-xs-12" name="tipogasto">
                                @foreach($tipogastos as $tipogasto)
                                  <option value="{{$tipogasto->id}}">{{$tipogasto->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
